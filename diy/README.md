# /diy — passphrase-gated 3D prints viewer
...
a new version or change the passphrase:
    ...
    python3 tools/encrypt_vault.py 'NEW-PASSPHRASE' ~/Documents/aliang8.github.io/diy/vault
    cd ~/Documents/aliang8.github.io && git add prints && git commit -m "prints: rebuild vault" && git push

Deep links work through the gate: `/diy/?m=collector&part=roller_hub_upper_R&step=12`.
